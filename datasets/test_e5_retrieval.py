...
from data_format import padding_seq_to_same_length, NQ_retrieval, hotpotqa_retrieval, popqa_retrieval, coral_retrieval, triviaqa_retrieval
import os
from os import path
...
def get_args():
    ...
    parser.add_argument("--test_file_path", type=str, default="../../datasets/triviaqa/flashrag_test.jsonl")
    ...
    parser.add_argument("--qrel_output_path", type=str, default="../../datasets/triviaqa")
    parser.add_argument("--output_trec_file", type=str, default="triviaqa_test_e5.trec")
