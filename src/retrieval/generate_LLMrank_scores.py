...
def main(queries_path, qid_map_path, RAG_text_path, output_path, batch_size=16):
    ...
    for line in qid_retrieval_map:
        ...
        qid2pid[q_sample["id"]] = q_sample["top_pid"][:5] + rel_items + irrel_items[:2]
...
if __name__ == "__main__":
    ...
    main(
        ...
        main(
        queries_path="../../datasets/hotpotqa/test.jsonl",        
        qid_map_path="../../datasets/hotpotqa/RAG_test_input.jsonl",
        RAG_text_path="../../datasets/wikipedia/pid2psg.pkl",     
        output_path="../../datasets/hotpotqa/test_LLM_rank_score.jsonl",
        batch_size=8
    )
    main(
        queries_path="../../datasets/hotpotqa/train.jsonl",        
        qid_map_path="../../datasets/hotpotqa/RAG_train_input.jsonl",
        RAG_text_path="../../datasets/wikipedia/pid2psg.pkl",     
        output_path="../../datasets/hotpotqa/test_LLM_rank_score.jsonl",
        batch_size=8
    )
